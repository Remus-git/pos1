...
<div class="bg-gray-50  p-3 sm:p-5 w-full">
                    ...
                    <div class="w-full md:w-1/2">
                        <form class="flex items-center" method="GET" action="search">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="text" id="service-search" name="query" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search" required="">
                            </div>
                        </form>
                    </div>
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Faulty</th>
                                <th scope="col" class="px-4 py-3">Passcode</th>
                                <th scope="col" class="px-4 py-3">Phone Number</th>
                                <th scope="col" class="px-4 py-3">Belongings</th>
                                <th scope="col" class="px-4 py-3">Prepaid Amount</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">{{$service->faulty}}</td>
                                <td class="px-4 py-3">{{$service->passcode}}</td>
                                <td class="px-4 py-3">{{$service->phone}}</td>
                                <td class="px-4 py-3">{{$service->belongings}}</td>
                                <td class="px-4 py-3">{{$service->prepaid}}</td>
